...
fun OpenRouterHelpContent() {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        Text(
            text = "Go back to 'AI Features' settings, make sure the backend is set to OpenRouter, and paste your key into the 'API Key' field.",
            style = MaterialTheme.typography.bodyMedium,
        )
        ...
        Text(
            text = "3. Choose Model, Provider & Level",
            style = MaterialTheme.typography.titleSmall,
            color = MaterialTheme.colorScheme.primary,
        )
        Text(
            text = "Select your preferred model tag (e.g. deepseek/deepseek-v4-flash-0731), optionally pin a provider such as deepinfra/fp4, and adjust the AI Intervention slider from Low to Max.",
            style = MaterialTheme.typography.bodyMedium,
        )
