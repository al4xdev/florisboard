    ...
    content {
        ...
        if (showPromptDialog) {
            ...
            JetPrefAlertDialog(
                ...
                onNeutral = {
                    val defaultPrompt = "You are Chewbacca the Wookiee. Translate all text into Shyriiwook (Wookiee roars like RAWRGWAWWGR, WAAAAHH, ARRRRRRRRRRR, GRRRRR, RWWGG). Keep technical terms intact if any. Reply ONLY with the Wookiee translation."
                    scope.launch {
